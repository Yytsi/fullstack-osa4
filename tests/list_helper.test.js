...
describe('total likes', () => {
  test('sum of likes over many blogs', () => {
    const blogs = [
      {
...
describe('most blogs', () => {
  ...
  test('return the author with the most blogs when the list size is 1', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
...
describe('most likes', () => {
  ...
  test('return the author with the most likes when the list size is 1', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
